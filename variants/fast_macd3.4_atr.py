    ...
    def next(self):
        ...
        if not self.position:  # 没有持仓
            ...
            if self.upCrossSignal.crossOver == 1 and self.fastMacd.l.signal[0] > 0:
                ...
                # ATR 止损保护：取 InOutLine 止损和 ATR 止损中更紧的
                ...
                msg = f"Buy tomorrow! Price: {current_price:.2f}, Target: {estimated_out_point_up:.2f}, Stop: {effective_stop:.2f}, Return: {estimated_return:.2f}%, Cat: {cat}, ATR: {self.atr[0]:.2f}"
